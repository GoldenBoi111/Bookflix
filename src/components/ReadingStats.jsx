...
const ReadingStats = () => {
  ...
  const radialData = [
    {
      name: "Progress",
      value: userStats.booksRead > userStats.annualGoal ? 100 : (userStats.booksRead / userStats.annualGoal) * 100,
      fill: "#e50914",
    },
  ];
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
              ...
              {userStats.booksRead > userStats.annualGoal && (
                <div className="mt-6 p-4 bg-gradient-to-r from-netflix-accent/20 to-[#ff4d4d]/20 rounded-xl border border-netflix-accent/50">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h3 className="font-black text-lg text-netflix-accent">Outstanding Performance!</h3>
                      <p className="text-netflix-light-gray text-sm">You've exceeded your annual goal. Would you like to set a new challenge?</p>
            ...
            <div className="relative w-56 h-56 flex items-center justify-center">
              <RadialBarChart
                ...
                height={224}
                startAngle={0}
                endAngle={userStats.booksRead > userStats.annualGoal ? 360 : (360 * userStats.booksRead) / userStats.annualGoal}
                cy="55%">
                <RadialBar
          ...
          <div className="space-y-8">
            ...
            <motion.div
              ...
              <div className="text-center mb-6 relative">
                ...
                <div className="text-netflix-gray text-sm">
                  Last 30 Days
                </div>
              ...
              <div className="mt-2">
                <div className="relative border border-[#808080]/30 rounded-lg p-4" onMouseMove={handleMouseMove}>
